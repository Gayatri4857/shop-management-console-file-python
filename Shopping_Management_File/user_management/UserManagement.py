...
class UserManagement:
    al = []
    file_path = r"C:\Users\hemag\PycharmProjects\Shopping_Management_File\user_management\Users.csv.py"

    @staticmethod  # Observe static method syntax
    def user_management():
    ...
    def save_data_to_file():
        ...
        with open(UserManagement.file_path, "w") as file:
            for user in UserManagement.al:
                file.write(f"{user.userName},{user.loginName},{user.password},{user.userRole}\n")
